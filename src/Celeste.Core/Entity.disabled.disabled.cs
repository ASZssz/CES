...
public class Entity : IEnumerable<Component>, IEnumerable
{
	...
	/*
	// Métodos de colisão comentados - dependem de classe Collide não disponível
	// Será implementado na integração completa
	...
	public List<Entity> CollideAllOutside(BitTag tag, Vector2 at)
	{
	...
	public List<T> CollideAllOutside<T>(Vector2 at) where T : Entity
	{
		List<T> list = new List<T>();
		foreach (Entity item in Scene.Tracker.Entities[typeof(T)])
		{
	...
	public List<T> CollideAllOutsideByComponent<T>(Vector2 at) where T : Component
	{
		List<T> list = new List<T>();
		foreach (Component item in Scene.Tracker.Components[typeof(T)])
		{
	...
	*/
	...
	// Stub methods para evitar erros de compilação
	public bool CollideCheck(Entity other) => false;
	public bool CollideCheck(Entity other, Vector2 at) => false;
	public bool CollideCheck(BitTag tag) => false;
	public bool CollideCheck(BitTag tag, Vector2 at) => false;
	public bool CollideCheck<T>() where T : Entity => false;
	public bool CollideCheck<T>(Vector2 at) where T : Entity => false;
	public bool CollideCheck<T, Exclude>() where T : Entity where Exclude : Entity => false;
	public bool CollideCheck<T, Exclude>(Vector2 at) where T : Entity where Exclude : Entity => false;
	public bool CollideCheck<T, Exclude1, Exclude2>() where T : Entity where Exclude1 : Entity where Exclude2 : Entity => false;
	public bool CollideCheck<T, Exclude1, Exclude2>(Vector2 at) where T : Entity where Exclude1 : Entity where Exclude2 : Entity => false;
	public bool CollideCheckByComponent<T>() where T : Component => false;
	public bool CollideCheckByComponent<T>(Vector2 at) where T : Component => false;
	public bool CollideCheckOutside(Entity other, Vector2 at) => false;
	public bool CollideCheckOutside(BitTag tag, Vector2 at) => false;
	public bool CollideCheckOutside<T>(Vector2 at) where T : Entity => false;
	public bool CollideCheckOutsideByComponent<T>(Vector2 at) where T : Component => false;
	public Entity CollideFirst(BitTag tag) => null;
	public Entity CollideFirst(BitTag tag, Vector2 at) => null;
	public T CollideFirst<T>() where T : Entity => null;
	public T CollideFirst<T>(Vector2 at) where T : Entity => null;
	public T CollideFirstByComponent<T>() where T : Component => null;
	public T CollideFirstByComponent<T>(Vector2 at) where T : Component => null;
	public Entity CollideFirstOutside(BitTag tag, Vector2 at) => null;
	public T CollideFirstOutside<T>(Vector2 at) where T : Entity => null;
	public T CollideFirstOutsideByComponent<T>(Vector2 at) where T : Component => null;
	public List<Entity> CollideAll(BitTag tag) => new List<Entity>();
	public List<Entity> CollideAll(BitTag tag, Vector2 at) => new List<Entity>();
	public List<Entity> CollideAll<T>() where T : Entity => new List<Entity>();
	public List<Entity> CollideAll<T>(Vector2 at) where T : Entity => new List<Entity>();
	public List<Entity> CollideAll<T>(Vector2 at, List<Entity> into) where T : Entity { into.Clear(); return into; }
	public List<T> CollideAllByComponent<T>() where T : Component => new List<T>();
	public List<T> CollideAllByComponent<T>(Vector2 at) where T : Component => new List<T>();
	public List<Entity> CollideAllOutside(BitTag tag, Vector2 at) => new List<Entity>();
	public List<T> CollideAllOutside<T>(Vector2 at) where T : Entity => new List<T>();
	public List<T> CollideAllOutsideByComponent<T>(Vector2 at) where T : Component => new List<T>();

	// Métodos CollideDo e CollidePoint comentados - uso de CollideCheck e Collide
	/*
	public List<Entity> CollideAll<T>(Vector2 at, List<Entity> into) where T : Entity
	{
		into.Clear();
	...
	*/
	...
	// Stubs para evitar erros de compilação
	public bool CollideLine(Vector2 from, Vector2 to, Vector2 at) => false;
	public bool CollideRect(Rectangle rect) => false;
	public bool CollideRect(Rectangle rect, Vector2 at) => false;
	public bool CollideDo(BitTag tag, Action<Entity> action) => false;
	public bool CollideDo(BitTag tag, Action<Entity> action, Vector2 at) => false;
	public bool CollideDo<T>(Action<T> action) where T : Entity => false;
	public bool CollideDo<T>(Action<T> action, Vector2 at) where T : Entity => false;
	public bool CollideDoByComponent<T>(Action<T> action) where T : Component => false;
	public bool CollideDoByComponent<T>(Action<T> action, Vector2 at) where T : Component => false;
	public bool CollidePoint(Vector2 point) => false;
	public bool CollidePoint(Vector2 point, Vector2 at) => false;
	public bool CollideLine(Vector2 from, Vector2 to) => false;
