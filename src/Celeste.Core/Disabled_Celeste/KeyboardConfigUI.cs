...
public class KeyboardConfigUI : TextMenu
{
	...
	public override void Render()
	{
		...
		if (remappingEase > 0f)
		{
			...
			ActiveFont.Draw(Dialog.Get("KEY_CONFIG_CHANGING"), vector + new Vector2(0f, -8f), new Vector2(0.5f, 1f), Vector2.One * 0.7f, Color.LightGray * Ease.CubeIn(remappingEase));
