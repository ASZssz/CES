...
public static class ParticleTypes
{
	...
	public static void Load()
	{
		...
		Chooser<MTexture> sourceChooser2 = new Chooser<MTexture>(GFX.Game["particles/zappysmoke00"], GFX.Game["particles/zappysmoke01"], GFX.Game["particles/zappysmoke02"], GFX.Game["particles/zappysmoke03"]);
