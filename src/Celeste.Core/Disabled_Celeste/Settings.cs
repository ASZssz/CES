...
public class Settings
{
	...
	// Corrigido: propriedade (não const) com getter.
	// Esse nome é o que o código usa no Load/Save.
	...
	public int MaxScale =>
		Math.Min(
			Engine.Instance.GraphicsDevice.Adapter.CurrentDisplayMode.Width / 320,
			Engine.Instance.GraphicsDevice.Adapter.CurrentDisplayMode.Height / 180
		);
